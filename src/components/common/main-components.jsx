...
const Faq = () => {
  return (
    <Accordion.Root collapsible defaultValue={["faq1"]} px="15%">
      {items.map((item, index) => (
        <Accordion.Item key={index} value={item.value} py="20px" borderColor={"white"}>
          <Accordion.ItemTrigger textAlign={"left"} px="15px">
            <Span flex="1">{item.title}</Span>
            <Accordion.ItemIndicator />
          </Accordion.ItemTrigger>
          <Accordion.ItemContent textAlign={"left"} px="15px">
...
const items = [
    {
        value: "faq1",
        title: <strong>Q: What makes XYZ Company's products so unique?</strong>,
    ...
    {
        value: "faq2",
        title: <strong>Q: How does XYZ Company contribute to sustainability and environmental conservation?</strong>,
    ...
    {
        value: "faq3",
        title: <strong>Q: What kind of support can customers expect from XYZ Company's customer service team?</strong>,
    ...
    {
        value: "faq4",
        title: <strong>Q: How does XYZ Company stay ahead of industry trends?</strong>,
    ...
    {
        value: "faq5",
        title: <strong>Q: Can you tell us about XYZ Company's commitment to community involvement?</strong>,
